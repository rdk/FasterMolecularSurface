...
class SurfaceBenchmark {
    ...
    private double[] runVariantTable(double solvent, int tess) {
        ...
        System.out.println("------------------------------------------------------------------------------------------------------------------------------");
        double sumFst = 0, sumSoa = 0, sumGrid = 0, sumOrd = 0, sumHint = 0, sumSym = 0, sumSymLA = 0, sumVec = 0, sumPrn = 0, sumDed = 0, sumGded = 0, sumTcd = 0, sumFlat = 0, sumAtcd = 0, sumAflat = 0, sumLean = 0, sumDirect = 0; int cdkCount = 0;
        for (TestStructures.Structure s : TestStructures.Structure.values()) {
            ...
            if (cdk != null) {
                ...
                sumAtcd += cdk / atcd; sumAflat += cdk / aflat; sumLean += cdk / lean; sumDirect += cdk / direct; cdkCount++;
            }
        ...
        return new double[]{ sumFst / c, sumSoa / c, sumGrid / c, sumOrd / c, sumHint / c, sumSym / c, sumSymLA / c, sumVec / c, sumPrn / c, sumDed / c, sumGded / c, sumTcd / c, sumFlat / c, sumAtcd / c, sumAflat / c, sumLean / c, sumDirect / c };
    }
