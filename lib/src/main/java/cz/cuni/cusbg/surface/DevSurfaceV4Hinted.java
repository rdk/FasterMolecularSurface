...
/**
 * Optimization step 4: {@link DevSurfaceV2Grid} plus a <em>last-occluder-first hint</em> in
 * the occlusion scan, and <em>no</em> neighbor sort.
 *
 * <p>Motivation: profiling {@link DevSurfaceV3Sorted} at low tessellation showed the
 ...
 */
public class DevSurfaceV4Hinted extends DevSurfaceV2Grid {

    public DevSurfaceV4Hinted(IAtomContainer atomContainer) {
        this(atomContainer, 1.4, 4);
    }

    public DevSurfaceV4Hinted(IAtomContainer atomContainer, double solventRadius, int tesslevel) {
